      ...
      <div className="container">
        <div className="grid md:grid-cols-3 pb-20 pt-5">
          <div className="py-8 px-4">
            ...
            <p className="text-gray-500 mt-4 dark:text-white/50">
          ...
          <div className="col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10">
            <div className="py-8 px-4 ">
              <ul className="list-none pl-6 leading-10 ">
                <h4 className="text-xl font-bold uppercase text-gray-800 dark:text-white/60">
                  Important Links
                </h4>
            ...
            <div className="py-8 px-4 col-span-2 sm:col-auto">
              <div>
                ...
                <div className="flex items-center gap-3 dark:text-white/50 mt-3">
                  <FaLocationArrow />
                  <p>Savar , Dhaka</p>
                </div>
                <div className="flex items-center gap-3 mt-5 dark:text-white/50">
                  <FaMobileAlt />
                  <p>+91 12345678</p>
                </div>
              </div>
